...
let toString = toString BigRational.toString Units.English Units.Short
...
module Demo =
    ...
    |> ValueUnit.toString BigRational.toString ValueUnit.Units.English ValueUnit.Units.Short
    |> ValueUnit.fromString
    |> ValueUnit.toString BigRational.toString ValueUnit.Units.English ValueUnit.Units.Short
